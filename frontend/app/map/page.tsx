...
export default function MapPage() {
  ...
  useEffect(() => {
    ...
    // Auto-spin the globe if not dragging
    const spin = () => {
      ...
      <div className="glass-panel flex-1 relative overflow-hidden flex items-center justify-center">
        {loading ? (
          ...
          >
            ...
            >
              <ZoomableGroup zoom={1} onMoveEnd={({ coordinates }) => setRotation(coordinates as [number, number, number])}>
        ...
        <div className="absolute bottom-6 right-6 pointer-events-none">
          <div className="bg-[#0f172a]/80 backdrop-blur border border-indigo-500/30 p-4 rounded-lg text-right">
            ...
            <div className="text-xs text-slate-500 font-mono mt-1">DATA: WEO/ACLED 2026 PROJECTIONS</div>
          </div>
        </div>
      </div>
    </div>
